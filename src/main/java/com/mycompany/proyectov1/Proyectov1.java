...
public class Proyectov1 {
    ...
    */
     // Fábrica 1 - Diseñada para cumplir objetivos
        ...
        fabrica1.encolaPedido(new Pedido(TipoAuto.SEDAN_LUJO, 5000));
        fabrica1.encolaPedido(new Pedido(TipoAuto.SUV_LUJO, 10000));
        fabrica1.encolaPedido(new Pedido(TipoAuto.PICKUP_ALTA_GAMA, 12000));
        ...
        // Encolar pedidos
        fabrica2.encolaPedido(new Pedido(TipoAuto.MAQUINARIA_ALTA_GAMA, 17500));
        fabrica2.encolaPedido(new Pedido(TipoAuto.SUPERAUTO_DEPORTIVO, 20000));
